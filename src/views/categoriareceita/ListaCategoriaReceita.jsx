...
import "./ListaCategoriaReceita.css";
import { notifyError, notifySuccess } from "../utils/Utils";
import { deletarCategoriaReceita } from '../../api/UserApi';

const ListaCategoriaReceita = () => {
  ...
  useEffect(() => {
    const getCategorias = async () => {
      try {
        const response = await axios.get("http://localhost:8085/api/categoriareceita");
  ...
  return (
    <>
      ...
      <Container className="container-bordered">
        <h1 className="containerHeader">Categorias de Receitas</h1>
        <Menu>
...
export default ListaCategoriaReceita;